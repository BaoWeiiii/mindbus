...
extension FileHandle {
    /// 整库扫描要顺序读十几 GB 的源文件，读过一遍就不再用：告诉内核别把它们留在系统
    /// 文件缓存里（F_NOCACHE）。否则别的 App 的页被挤出去，用户的感受就是「整个系统
    /// 卡了几秒」。只是提示，读的内容与顺序都不变。
    func markStreamingRead() {
