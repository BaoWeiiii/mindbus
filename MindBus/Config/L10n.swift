...
struct Strings {
    ...
    static let zh = Strings(
        ...
        mindsSubtitle: "你的自述——每一行都是数出来的，不是生成的",
        mindsTrustSuffix: "counted, not generated",
        mindsGroupForYou: "给你的 · 你可能没意识到的",
        mindsGroupForAI: "给你的 AI 的 · agent 消费的画像",
        ...
        mSanctuaryHead: { "\($0) 场对话 · \($1) 份归档副本(\($2))· 库的第 \($3) 天" },
        mSanctuaryRescued: { "\($0) 场对话已被源工具删除——在这里,它们还在" },
        mSanctuaryOutlived: { "\($0) 场对话已越过 Claude Code 的 30 天清理线——在这里,它们永远都在" },
        ...
        mindsBriefingsHint: "值得沉淀成模板或 Skill 的重复指令",
        mindsSecSanctuary: "永久留底",
        mindsSanctuaryHint: "存在你的硬盘上,不经你的手,谁也拿不走",
        mindsSecShape: "协作形状",
        mindsShapeHint: "你不是问答，是共事——用形状证明",
        ...
        mindsCatchphrasesHint: "你反复发出的短句，如实计数",
        ...
        mindsSpotStyle: "协作风格",
        mindsSpotGoals: "当前目标",
        mindsSpotStack: "技术栈自述",
        mindsBadgeUnreviewed: "AI 补充 · 待确认",
        mindsBadgeConfirmed: "已确认",
        mindsConfirm: "确认",
        mindsRevoke: "撤销",
        mindsSources: "证据",
        mindsSpotEmpty: "尚无内容 —— 空位等待补充",
        mindsEnrichHint: "四个空位由你的 AI 工具补充：在 Claude Code 里说「读一下我的 Minds，把能补的空位用 minds_enrich 补上」。每条补充都必须带对话溯源，凭空编造会被拒绝。",
        mindsEntitiesHint: "点击查看相关会话",
        mindsVocabularyHint: "从语料统计出的个人词表 · 点击搜索",
        ...
        mindsInjectAction: "注入到 CLAUDE.md",
        mindsInjectUpdate: "更新 CLAUDE.md 注入",
        mindsInjectRemove: "移除注入",
